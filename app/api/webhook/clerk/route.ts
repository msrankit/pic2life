...
export async function POST(req: Request) {
  ...
  // Handle events
  const { id, email_addresses, image_url, first_name, last_name, username } = evt.data as UserJSON;
  ...
  try {
    switch (eventType) {
      case "user.created": {
        ...
        const user = {
          clerkId: id,
          email: email || "", // Default to empty string if email is null/undefined
          username: username || "", // Default to empty string if username is null/undefined
